...
public class CommerceFieldSource : BaseFieldSource
{
    ...
    protected override IEnumerable<IField> GetFieldsInternal()
    {
        ...
        yield return new Field<string>(Faker, () => Faker.Commerce.ProductAdjective(), "Product Adjective");
        yield return new Field<string>(Faker, () => Faker.Commerce.ProductMaterial(), "Product Material");
        yield return new Field<string>(Faker, () => Faker.Commerce.Ean8(), "Ean8");
        yield return new Field<string>(Faker, () => Faker.Commerce.Ean13(), "Ean13");
    }
}